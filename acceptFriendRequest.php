...
$mysqli =dbconnect();
$addFriend = $mysqli->prepare("UPDATE `add_friend` SET `status`='accepted' , `last_status_change`=CURRENT_TIMESTAMP WHERE requester_username=? AND requestee_username=? ");
...
<div class="pageContainer">
    ...
    <div class="requestSent">
       Your friend "<?php echo $requestee_username ?>" has been added.<br>
