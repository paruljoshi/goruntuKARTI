...
<div class="pageContainer">
    ...
    <div class="editProfile">
        ...
        <form action="updateEditProfileDetails.php?username=<?php echo $username?>" method="post">
             Name: <input id="textbox" type="text" placeholder="Name" name="newName"  value="<?php echo $name ?>"> <br><br>
             Email: <input id="textbox" type="text" placeholder="Email" name="newUseremail" value="<?php echo $useremail ?>" > <br><br>
            Password: <input id="textbox" type="password" placeholder="password" name="newPassword"><br><br>
            ReEnter : <input id="textbox" type="password" placeholder="Re-enter password" name="samePassword"><br><br>
